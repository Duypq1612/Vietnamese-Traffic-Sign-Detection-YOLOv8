...
---
## 📦 3. Tài nguyên Dự án (Project Assets)
Để giúp cộng đồng dễ dàng tái lập kết quả hoặc tích hợp vào ứng dụng thực tế, mình chia sẻ sẵn bộ trọng số và dữ liệu đã qua tiền xử lý:

📥 Model Checkpoint
Do giới hạn dung lượng của GitHub, file trọng số (.pt) được lưu trữ tại Google Drive. Đây là phiên bản tốt nhất đã qua tinh chỉnh:

Best Trained Model: 👉 Tải xuống tại đây https://drive.google.com/drive/folders/1TFp8CHl1m8XHMl3gdcCmyxhndnSJW9t1?usp=sharing

Trọng lượng: ~6.5 MB (YOLOv8n)

Cách dùng: Sau khi tải về, đặt file vào thư mục gốc hoặc thư mục weights/ và trỏ đường dẫn trong code nhận diện.

💿 Dataset Access
Bạn có thể truy cập trực tiếp bộ dữ liệu đã được gán nhãn và chia tập Train/Val/Test tại Roboflow:

Roboflow Link: Vietnam Traffic Sign Dataset v3

Format: YOLO v8

Ghi chú: Dataset đã được mình xử lý kỹ thuật để gộp từ 56 lớp chi tiết về 4 nhóm biển báo chính (Cấm, Nguy hiểm, Hiệu lệnh, Chỉ dẫn).

---

## 📈 4. Đánh giá Mô hình (Results & Evaluation)
